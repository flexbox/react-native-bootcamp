...
- Learn how to debug your React Native project with the Expo debugger.
...
> ⚠️ The Expo debugger **cannot** throttle or simulate a slow network connection — the old React Native Debugger "Network" throttling is gone.

To test offline / poor connectivity, toggle **Airplane mode** on your device or simulator, or use your OS network link conditioner.

### Expo debugger shortcuts
