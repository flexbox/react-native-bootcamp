...
- Running [`yarn create expo --help`](https://docs.expo.dev/get-started/installation/) should not output any error.
...
```console
yarn create expo spacecraft --template expo-template-blank-typescript
```
...
- [ ] Create 2 folders `src` and `screens` like this
