...
if you have issues double check the [setup instruction on the documentation](https://callstack.github.io/react-native-paper/getting-started.html#installation).

- [ ] Paste your LoginScreen from the exercice 1 Snack into `App.tsx`

Congratulations 👏! You should have something like this:

<img src="Login Screen Preview" alt="https://raw.githubusercontent.com/flexbox/react-native-workshop/main/challenges/foundation/login.png" width="50%" height="50%" />

For the next step we are going to create another Screen.
...
As you can see, we are using the `Text` component __exported from `react-native-paper`__ instead of the Text component from `react-native`. This is because we want to ensure that our text will use the same theme.
