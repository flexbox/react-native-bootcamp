...
- [ ] Go to the [Expo dashboard](https://expo.dev/) and create a new project (or link this app to an existing one). The dashboard handles builds, updates and deployments for you.
