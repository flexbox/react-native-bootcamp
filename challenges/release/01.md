...
Next time we will launch our project with `npx expo start`, we will see a new option to use the development client.
...
The build runs on Expo's servers and can take around ⌛ 30 min.
