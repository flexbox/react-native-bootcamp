...
export declare const LABEL_PADDING_HORIZONTAL = 12;
export declare const ADORNMENT_SIZE = 24;
export declare const ADORNMENT_OFFSET = 12;
export declare const FLAT_INPUT_OFFSET = 8;
export declare const OUTLINED_INPUT_OFFSET = 8;
