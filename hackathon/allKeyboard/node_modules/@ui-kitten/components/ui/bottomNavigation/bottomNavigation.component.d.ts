...
declare type BottomNavigationStyledProps = Overwrite<StyledComponentProps, {
...
export declare type BottomNavigationElement = React.ReactElement<BottomNavigationProps>;
/**
 ...
 */
export declare class BottomNavigation extends React.Component<BottomNavigationProps> {
