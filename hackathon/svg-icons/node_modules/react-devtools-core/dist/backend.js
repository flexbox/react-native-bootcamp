...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return StrictMode; });
/**
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return TREE_OPERATION_ADD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return TREE_OPERATION_REMOVE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return TREE_OPERATION_REORDER_CHILDREN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return TREE_OPERATION_REMOVE_ROOT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return TREE_OPERATION_SET_SUBTREE_MODE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return SESSION_STORAGE_LAST_SELECTION_KEY; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return SESSION_STORAGE_RELOAD_AND_PROFILE_KEY; });
...
/* harmony import */ var shared_ReactSymbols__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
...
/* harmony import */ var _hydration__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
...
function printOperationsArray(operations) {
  ...
  while (i < operations.length) {
    ...
    switch (operation) {
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_REMOVE */ "k"]:
        {
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_REMOVE_ROOT */ "l"]:
        {
          i += 1;
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_SET_SUBTREE_MODE */ "n"]:
        {
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_REORDER_CHILDREN */ "m"]:
        {
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */ "p"]:
      ...
      case _constants__WEBPACK_IMPORTED_MODULE_3__[/* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */ "o"]:
...
function getSavedComponentFilters() {
  try {
    var raw = Object(_storage__WEBPACK_IMPORTED_MODULE_5__[/* localStorageGetItem */ "a"])(_constants__WEBPACK_IMPORTED_MODULE_3__[/* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */ "a"]);
...
function getAppendComponentStack() {
  try {
    var raw = Object(_storage__WEBPACK_IMPORTED_MODULE_5__[/* localStorageGetItem */ "a"])(_constants__WEBPACK_IMPORTED_MODULE_3__[/* LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY */ "e"]);
...
function getBreakOnConsoleErrors() {
  try {
    var raw = Object(_storage__WEBPACK_IMPORTED_MODULE_5__[/* localStorageGetItem */ "a"])(_constants__WEBPACK_IMPORTED_MODULE_3__[/* LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS */ "d"]);
...
/* harmony import */ var _hydration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
      ...
      try {
        ...
        var overrideMethod = function overrideMethod() {
          if (!consoleSettingsRef.hideConsoleLogsInStrictMode) {
            ...
            // hiding them.
            if (isNode) {
              originalMethod(DIMMED_NODE_CONSOLE_COLOR, _utils__WEBPACK_IMPORTED_MODULE_0__[/* format */ "f"].apply(void 0, arguments));
            } else {
              var color = getConsoleColor(method);

              if (color) {
                originalMethod("%c".concat(_utils__WEBPACK_IMPORTED_MODULE_0__[/* format */ "f"].apply(void 0, arguments)), "color: ".concat(color));
              } else {
...
// EXTERNAL MODULE: /Users/bvaughn/Documents/git/react.devtools/build/oss-experimental/react-debug-tools/index.js
...
function crawlData(data, sources, resolvedStyles) {
  if (Object(src_isArray["a" /* default */])(data)) {
    data.forEach(function (entry) {
      if (Object(src_isArray["a" /* default */])(entry)) {
...
function createProfilingHooks(_ref) {
  ...
  function markMetadata() {
    ...
    if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ !== 'undefined' && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.getInternalModuleRanges === 'function') {
      ...
      if (Object(isArray["a" /* default */])(ranges)) {
        for (var i = 0; i < ranges.length; i++) {
          var range = ranges[i];

          if (Object(isArray["a" /* default */])(range) && range.length === 2) {
  ...
  function markCommitStarted(lanes) {
    if (supportsUserTimingV3) {
      markAndClear("--commit-start-".concat(lanes)); // Certain types of metadata should be logged infrequently.
  ...
  function markComponentSuspended(fiber, wakeable, lanes) {
    if (supportsUserTimingV3) {
      ...
      var displayName = wakeable.displayName || ''; // TODO (timeline) Record and cache component stack
...
function attach(hook, rendererID, renderer, global) {
  ...
  function updateComponentFilters(componentFilters) {
    ...
    hook.getFiberRoots(rendererID).forEach(function (root) {
      ...
      pushOperation(constants["l" /* TREE_OPERATION_REMOVE_ROOT */]);
  ...
  function isEffect(memoizedState) {
    ...
    return boundHasOwnProperty('create') && boundHasOwnProperty('destroy') && boundHasOwnProperty('deps') && boundHasOwnProperty('next') && boundHasOwnProperty('tag') && (deps === null || Object(isArray["a" /* default */])(deps));
  }
  ...
  function flushPendingEvents(root) {
    ...
    if (numUnmountIDs > 0) {
      ...
      operations[i++] = constants["k" /* TREE_OPERATION_REMOVE */]; // The first number is how many unmounted IDs we're gonna send.
  ...
  function recordMount(fiber, parentFiber) {
    ...
    if (isRoot) {
      ...
      if ((fiber.mode & StrictModeBits) !== 0 && (parentFiber.mode & StrictModeBits) === 0) {
        pushOperation(constants["n" /* TREE_OPERATION_SET_SUBTREE_MODE */]);
        pushOperation(id);
        pushOperation(types["p" /* StrictMode */]);
      }
    }
  ...
  function recordProfilingDurations(fiber) {
    ...
    if (isProfiling) {
      ...
      if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
        ...
        pushOperation(constants["p" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
        pushOperation(id);
  ...
  if (Object(storage["c" /* sessionStorageGetItem */])(constants["i" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
    startProfiling(Object(storage["c" /* sessionStorageGetItem */])(constants["h" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true');
...
__webpack_require__(24); // On some exotic environments, it's not clear which object `setimmediate` was
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(14), __webpack_require__(17)))
...
var h = __webpack_require__(8),
    ...
    q = __webpack_require__(31).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    w = [],
    x = null;
  ...
  if (null === x) {
    ...
    try {
      z.useContext({
        ...
        return a;
      }, null), z.useRef(null), "function" === typeof z.useCacheRefresh && z.useCacheRefresh(), z.useLayoutEffect(function () {}), z.useInsertionEffect(function () {}), z.useEffect(function () {}), z.useImperativeHandle(void 0, function () {
        return null;
...
function F(a, b, e) {
  for (var f = [], c = null, m = f, r = 0, t = [], v = 0; v < b.length; v++) {
    ...
    b: {
      n = k;
      p = y().get(u.primitive);
      if (void 0 !== p) for (g = 0; g < p.length && g < n.length; g++) {
...
function G(a, b) {
  for (var e = [], f = 0; f < a.length; f++) {
    var c = a[f];
    "DebugValue" === c.name && 0 === c.subHooks.length ? (a.splice(f, 1), f--, e.push(c)) : G(c.subHooks, c);
  }
...
exports.version = "18.0.0-rc.0-experimental-13036bfbc-20220121";
...
var agent_Agent = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Agent(bridge) {
    ...
    agent_defineProperty(agent_assertThisInitialized(_this), "reloadAndProfile", function (recordChangeDescriptions) {
      Object(storage["e" /* sessionStorageSetItem */])(constants["i" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */], 'true');
      Object(storage["e" /* sessionStorageSetItem */])(constants["h" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */], recordChangeDescriptions ? 'true' : 'false'); // This code path should only be hit if the shell has explicitly told the Store that it supports profiling.
    ...
    agent_defineProperty(agent_assertThisInitialized(_this), "_throttledPersistSelection", lodash_throttle_default()(function (rendererID, id) {
      ...
      if (path !== null) {
        Object(storage["e" /* sessionStorageSetItem */])(constants["g" /* SESSION_STORAGE_LAST_SELECTION_KEY */], JSON.stringify({
          rendererID: rendererID,
          path: path
        }));
      } else {
        Object(storage["d" /* sessionStorageRemoveItem */])(constants["g" /* SESSION_STORAGE_LAST_SELECTION_KEY */]);
      }
    }, 1000));

    if (Object(storage["c" /* sessionStorageGetItem */])(constants["i" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
      _this._recordChangeDescriptions = Object(storage["c" /* sessionStorageGetItem */])(constants["h" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true';
      _this._isProfiling = true;
      Object(storage["d" /* sessionStorageRemoveItem */])(constants["h" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]);
      Object(storage["d" /* sessionStorageRemoveItem */])(constants["i" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]);
    }

    var persistedSelectionString = Object(storage["c" /* sessionStorageGetItem */])(constants["g" /* SESSION_STORAGE_LAST_SELECTION_KEY */]);
